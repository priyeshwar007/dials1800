  ...
  <!-- Bootstrap -->
  <link href="{{ url('/adminlte/bootstrap/bootstrap.min.css') }}" rel="stylesheet">
  <!-- Font Awesome -->
  <link href="{{ url('/adminlte/plugins/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
  <!-- Owl Carousel -->
  <link href="{{ url('/adminlte/plugins/slick-carousel/slick/slick.css') }}" rel="stylesheet">
  <link href="{{ url('/adminlte/plugins/slick-carousel/slick/slick-theme.css') }}" rel="stylesheet">
  <!-- Fancy Box -->
